                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-1">
                            <div class="col-md-6 offset-md-4">
                                <input type="checkbox" name="terms_privacy" id="terms_privacy" value="sim" class=" @error('terms_privacy') is-invalid @enderror">
                                <label for="terms_privacy">     Aceitar nossos <a href='{{route("/terms_privacy")}}' target="_BLANK">Termos</a></label>

...
<div class="container-fluid">
    <div class="d-flex align-items-center justify-content-between mt-3 mx-3">
        <h1 class="m-0">Lista de Visitantes</h1>
    </div>
    <hr>
    <div class="d-flex align-items-center justify-content-between mt-0 mx-3 flex-wrap">
      <form class="d-flex justify-content-between align-items-center form-control p-0 m-0 w-auto form-search" id="form-search" method="GET" action="{{ route('visitors') }}">
          @csrf
            ...
            @foreach($visitors as $user)
              ...
              <td>
                <div class="d-flex align-items-center">
                  ...
                  <form action="{{route('visitors.switch',$user)}}" method="post" class="me-1">
                    @csrf
                    @method("PUT")
                  ...
                  {{-- Botão de excluir --}}
                  <form action="{{route('visitors.destroy',$user)}}" method="post">
                    @csrf
                    @method("DELETE")
